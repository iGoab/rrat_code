...
double psr_phase_avg(const struct polyco *pc, int mjd, double fmjd1, double fmjd2);
...
int make_polycos(const char *parfile, struct hdrinfo *hdr, char *src, struct polyco **pc);
#endif
